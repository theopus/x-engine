...
/**
 * Base NanoVG org.lwjgl.demo class.
 *
...
class Demo {
    ...
    static class DemoData {
        ...
        final ByteBuffer entypo           = loadResource("entypo.ttf", 40 * 1024);
        final ByteBuffer RobotoRegular    = loadResource("Roboto-Regular.ttf", 150 * 1024);
        final ByteBuffer RobotoBold       = loadResource("Roboto-Bold.ttf", 150 * 1024);
        final ByteBuffer NotoEmojiRegular = loadResource("NotoEmoji-Regular.ttf", 450 * 1024);
    ...
    static int loadDemoData(long vg, DemoData data) {
        ...
        for (int i = 0; i < 12; i++) {
            String     file = "images/image" + (i + 1) + ".jpg";
