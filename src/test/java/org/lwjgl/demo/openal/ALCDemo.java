...
import static org.lwjgl.demo.openal.OpenALInfo.checkALCError;
import static org.lwjgl.demo.openal.OpenALInfo.checkALError;
...
public final class ALCDemo {
    ...
    private static void testPlayback() {
        ...
        try (STBVorbisInfo info = STBVorbisInfo.malloc()) {
            ShortBuffer pcm = readVorbis("org/lwjgl/demo/footsteps.ogg", 32 * 1024, info);
