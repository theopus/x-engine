...
public final class Truetype extends FontDemo {
    ...
    private Truetype(String filePath) {
        ...
        try {
            ttf = ioResourceToByteBuffer("org/lwjgl/demo/FiraSans.ttf", 512 * 1024);
        } catch (IOException e) {
    ...
    public static void main(String[] args) {
        String filePath;
        if (args.length == 0) {
            System.out.println("Use 'ant org.lwjgl.demo -Dclass=org.lwjgl.org.lwjgl.demo.stb.Truetype -Dargs=<path>' to load a different text file (must be UTF8-encoded).\n");
