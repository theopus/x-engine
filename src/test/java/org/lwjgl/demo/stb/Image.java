...
public final class Image {
    ...
    private Image(String imagePath) {
        ...
        try (MemoryStack stack = stackPush()) {
            ...
            // We don't need this for this org.lwjgl.demo, just testing the API.
    ...
    public static void main(String[] args) {
        String imagePath;
        if (args.length == 0) {
            System.out.println("Use 'ant org.lwjgl.demo -Dclass=org.lwjgl.org.lwjgl.demo.stb.Image -Dargs=<path>' to load a different image.\n");
