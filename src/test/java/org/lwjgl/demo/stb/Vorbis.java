...
public final class Vorbis implements AutoCloseable {
    ...
    private Vorbis(String filePath) {
        ...
        if (Platform.get() == Platform.MACOSX) {
            ...
            //     * Normally we'd render to an FBO and upscale to the window framebuffer. We simply use a scaled glOrtho in this org.lwjgl.demo.
        ...
        window = glfwCreateWindow(framebufferW, framebufferH, "stb_vorbis org.lwjgl.demo", NULL, NULL);
        if (window == NULL) {
    ...
    public static void main(String[] args) {
        String filePath;
        if (args.length == 0) {
            System.out.println("Use 'ant org.lwjgl.demo -Dclass=org.lwjgl.org.lwjgl.demo.stb.Vorbis -Dargs=<path>' to load a different Ogg Vorbis file.\n");
            filePath = "org/lwjgl/demo/phero.ogg";
        } else {
            filePath = args[0];
        }
